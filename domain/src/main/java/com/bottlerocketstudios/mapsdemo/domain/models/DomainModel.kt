 ...
 *
 * [DomainModel]s exist to be a primary representation of data that is used throughout the app that has already been preprocessed (deserialized) from some "dirty" model such as the network/database.
